...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <div class="panel-body">
                            <asp:GridView ID="dgvCorreoFormulario" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEliminarCorreoModal" runat="server" Text="<i class='glyphicon glyphicon-trash'></i> Eliminar" CssClass="btn btn-danger btn-xs" OnClick="btnEliminarCorreoModal_Click"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
    ...
    <div class="modal fade"  id="modalTelefono" role="dialog" aria-labelledby="modalLabelTelefono" aria-hidden="false">
