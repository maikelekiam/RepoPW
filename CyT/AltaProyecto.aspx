...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <asp:Panel ID="Panel1" runat="server">
            ...
            <div class="form-group">
                <asp:Label ID="lblBeneficiario" runat="server" Text="BENEFICIARIOS" CssClass="col-md-2 control-label"> </asp:Label>
                <div class="col-md-4">
                    <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#modalBeneficiarios">Agregar Beneficiario</button>
                </div>
                <!-- MODAL LISTA DE BENEFICIARIOS  -->
                <div class="modal fade" id="modalBeneficiarios" tabindex="-1" role="dialog" aria-labelledby="modalLabelBeneficiario" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="modalLabelBeneficiarios">Beneficiarios</h4>
                            </div>
                            <div class="modal-body">
                                <br />
                                <asp:Label ID="lblSeleccionar" runat="server" Text="Seleccionar" CssClass="col-md-4 control-label"> </asp:Label>
                                <div class="col-md-8 ">
                                    <asp:DropDownList ID="ddlBeneficiario" runat="server"
                                        ...
                                        data-live-search="true"
                                        data-width="auto">
                                        <asp:ListItem Value="-1">&lt;Seleccione Beneficiarios&gt;</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <br />
                            </div>
                            <div class="modal-footer">
                                ...
                                <asp:Button runat="server" ID="btnModalBeneficiarioGuardar" Text="GUARDAR" CssClass="btn btn-success" OnClick="btnModalBeneficiarioGuardar_Click" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-md-offset-0">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title">Beneficiarios</h2>
                            <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
                        </div>
                        <div class="panel-body">
                            <asp:GridView ID="dgvBeneficiarios" runat="server" AutoGenerateColumns="false"
                                Width="300"
                                ShowHeader="false"
                                GridLines="None"
                                AutoGenerateDeleteButton="false">
                                <Columns>
                                    <asp:BoundField HeaderStyle-BackColor="#cccccc" HeaderText="ID" DataField="idPersona" ItemStyle-HorizontalAlign="Center" />

                                    <asp:BoundField HeaderStyle-BackColor="#cccccc" HeaderText="Apellido" DataField="apellido" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField HeaderStyle-BackColor="#cccccc" HeaderText="Nombre" DataField="nombre" ItemStyle-HorizontalAlign="Center" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEliminarBeneficiario" runat="server" Text="<i class='glyphicon glyphicon-trash'></i> Eliminar"
                                                CssClass="btn btn-danger btn-xs" CommandName="Add" CommandArgument='<%# ((GridViewRow)Container).RowIndex %>' OnCommand="btnEliminarBeneficiario_Command"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
