...
namespace CyT
{
    public partial class ListarConvocatoriasPermanentes : System.Web.UI.Page
    {
        ...
        private void CargarConvocatorias()
        {
            ...
            dgvConvocatoria.DataSource = convocatoriaNego.MostrarConvocatoriasPorModalidad(modalidadNego.ObtenerModalidadPorNombre("Permanente"));
